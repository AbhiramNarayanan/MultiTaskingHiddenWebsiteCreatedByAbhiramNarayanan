        ...
        <div class="middle-section">
          <div class="section">
            <video autoplay muted loop>
              <source src="/videos/background_-_33633 (Original).mp4" type="video/mp4">
            </video>
            <button class="section-btn">Click me</button>
          </div>
          <div class="section">
            <video autoplay muted loop>
              <source src="/videos/firework_-_121793 (1080p).mp4" type="video/mp4">
            </video>
            <button class="section-btn">Click me</button>
          </div>
          <div class="section">
            <video autoplay muted loop>
              <source src="/videos/night_sky_-_31569 (Original).mp4" type="video/mp4">
            </video>
